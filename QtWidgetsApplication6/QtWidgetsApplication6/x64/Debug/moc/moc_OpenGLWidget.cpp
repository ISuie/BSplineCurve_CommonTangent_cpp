...
QT_MOC_LITERAL(1, 13, 14), // "pointTextReady"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 4) // "data"

    },
    "OpenGLWidget\0pointTextReady\0\0data"
};
...
void OpenGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pointTextReady((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (OpenGLWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OpenGLWidget::pointTextReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void OpenGLWidget::pointTextReady(const QString & _t1)
{
